...
// ---------- Configure this ----------
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyxFXMeIGjAKopm8OVuyzAGq0pXcawaXzmSLnz9PLKC5atAvs7zMjdEQgA4VpACgair/exec';
// -------------------------------------
  ...
  function jsonp(payload, { retries = 3, timeoutMs = 30000 } = {}) {
    return (async () => {
      let lastErr;
